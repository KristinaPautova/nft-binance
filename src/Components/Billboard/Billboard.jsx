      ...
      <div className="home__main">
        <div className="home__main_left">
          ...
          <div className="left__text">
            With Binance NFT’s beginner-friendly minting feature, verified
            Binance users can create their own NFTs in just a few clicks! Start
            minting your own NFTs with Binance NFT today!
          </div>
